...
namespace PokemonReviewApp.Controllers
{
    ...
    public class CountryController : Controller
    {
        ...
        public IActionResult UpdateCounrty(int countryId, [FromBody] CountryDto updateCountry)
        {
            ...
            var countryDto = _mapper.Map<Country>(updateCountry);

            if (!_countryRepository.UpdateCountry(countryDto))
            {
